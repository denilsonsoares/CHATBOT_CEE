...
# Função para ler a chave da API do Gemini do arquivo .txt
...
# Função para extrair informações da vaga usando a API do Gemini
...
def main():
    ...
    try:
        ...
        print(f"Erro durante a extração de informações: {e}")

    # Salvar os dados coletados até o momento da falha
    df = pd.DataFrame(data, columns=columns)
    df.to_excel('job_info_gemini.xlsx', index=False)
